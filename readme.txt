...
== Description ==
FLASHPAY’s WooCommerce plugin is a complete growth-focused payment solution for merchants looking to dominate local markets or expand globally, maximise profits and reduce operational costs.
...
== Installation ==
1. Upload the 'woocommerce-flashpay' folder to /wp-content/plugins/ on your server.
2. Log in to WordPress administration, click on the 'Plugins' tab.
3. Find FLASHPAY in the plugin overview and activate it.
4. Go to WooCommerce -> Settings -> Payment Gateways -> FLASHPAY.
...
2. [Create a merchant account](https://flashpay.kg/technologies/integrations/woocommerce-payment-gateway/?utm_source=plugin_description&utm_medium=link&utm_campaign=woocommerce) with FLASHPAY and provide all the necessary documents
...
* Fix: Exception on invalid data from FLASHPAY Payment Platform.
...
* Feature: Customer identifier always send to FLASHPAY Payment Platform.
...
= 2.0.1 =
* Fix: Exception on undefined array key "flashpay_test".
