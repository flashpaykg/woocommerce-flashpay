...
class Ep_Gateway_API_Protocol extends Ep_Gateway_Registry
{
    /**
     * @inheritDoc
     * @return void
    ...
    {
        add_filter('ep_create_general_data', [$this, 'create_general_info'], 10, 1);
        add_filter('ep_create_payment_data', [$this, 'create_payment_data'], 10, 1);
        add_filter('ep_create_payment_info', [$this, 'create_payment_info'], 10, 1);

        // register filters for appending payment arguments
        add_filter('ep_append_project_id', [$this, 'append_project_id'], 10, 1);
        add_filter('ep_append_interface_type', [$this, 'append_interface_type'], 10, 2);
        add_filter('ep_append_card_operation_type', [$this, 'append_card_operation_type'], 10, 2);
        add_filter('ep_append_operation_mode', [$this, 'append_operation_mode'], 10, 2);
        add_filter('ep_append_force_mode', [$this, 'append_force_mode'], 10, 2);
        add_filter('ep_append_display_mode', [$this, 'append_display_mode'], 10, 3);
        add_filter('ep_append_payment_section', [$this, 'append_payment_section'], 10, 2);
        add_filter('ep_append_language_code', [$this, 'append_language'], 10, 1);
        add_filter('ep_append_merchant_success_url', [$this, 'append_merchant_success_url'], 10, 2);
        add_filter('ep_append_merchant_fail_url', [$this, 'append_merchant_fail_url'], 10, 2);
        add_filter('ep_append_merchant_return_url', [$this, 'append_merchant_return_url'], 10, 2);
        add_filter('ep_append_redirect_url', [$this, 'append_redirect_url'], 10, 2);
        add_filter('ep_append_merchant_callback_url', [$this, 'append_merchant_callback_url'], 10, 1);
        add_filter('ep_append_customer_data', [$this, 'append_customer_data'], 10, 2);
        add_filter('ep_append_customer_id', [$this, 'append_customer_id'], 10, 2);
        add_filter('ep_append_customer_phone', [$this, 'append_customer_phone'], 10, 2);
        add_filter('ep_append_customer_email', [$this, 'append_customer_email'], 10, 2);
        add_filter('ep_append_customer_last_name', [$this, 'append_customer_last_name'], 10, 2);
        add_filter('ep_append_customer_first_name', [$this, 'append_customer_first_name'], 10, 2);
        add_filter('ep_append_customer_country', [$this, 'append_customer_country'], 10, 2);
        add_filter('ep_append_customer_state', [$this, 'append_customer_state'], 10, 2);
        add_filter('ep_append_customer_city', [$this, 'append_customer_city'], 10, 2);
        add_filter('ep_append_customer_address', [$this, 'append_customer_address'], 10, 2);
        add_filter('ep_append_customer_zip', [$this, 'append_customer_zip'], 10, 2);
        add_filter('ep_append_avs_post_code', [$this, 'append_avs_post_code'], 10, 2);
        add_filter('ep_append_avs_street_address', [$this, 'append_avs_street_address'], 10, 2);
        add_filter('ep_append_billing_data', [$this, 'append_billing_data'], 10, 2);
        add_filter('ep_append_billing_address', [$this, 'append_billing_address'], 10, 2);
        add_filter('ep_append_billing_city', [$this, 'append_billing_city'], 10, 2);
        add_filter('ep_append_billing_country', [$this, 'append_billing_country'], 10, 2);
        add_filter('ep_append_billing_postal', [$this, 'append_billing_postal'], 10, 2);
        add_filter('ep_append_billing_region', [$this, 'append_billing_region'], 10, 2);
        add_filter('ep_append_billing_region_code', [$this, 'append_billing_region_code'], 10, 2);
        add_filter('ep_append_additional_variables', [$this, 'append_custom_variables'], 10, 2);
        add_filter('ep_payment_page_clean_parameters', [$this, 'filter_clean'], 10, 1);
        add_filter('ep_append_recurring', [$this, 'append_recurring'], 10, 2);
        add_filter('ep_append_shipping_data', [$this, 'filter_shipping_data'], 10, 2);
        add_filter('ep_append_receipt_data', [$this, 'filter_receipt_data'], 10, 3);
        add_filter('ep_append_cash_voucher_data', [$this, 'filter_cash_voucher_data'], 10, 2);
        add_filter('ep_append_versions', [$this, 'append_versions'], 10, 1);
        add_filter('ep_append_signature', [$this, 'append_signature'], 10, 1);
    }

    /**
     * @param Ep_Gateway_Order|Ep_Gateway_Refund $order
     * @return array
     */
    public function create_payment_data($order)
    {
        $data = apply_filters('ep_append_project_id', []);

        switch (true) {
            case $order instanceof Ep_Gateway_Order:
                // Identifier of the payment, must be unique within the project.
                $this->append_argument('payment_id', $order->create_payment_id(), $data);
                break;
            case $order instanceof Ep_Gateway_Refund:
                // Identifier of the payment, must be unique within the project.
    ...
    public function create_general_info($order)
    {
        ...
        switch (true) {
            case is_string($order):
                // Identifier of the request from FLASHPAY payment platform.
    ...
    public function create_payment_info($order)
    {
        ...
        $this->append_argument(
            'amount',
            ep_price_multiply(abs($order->get_total()), $order->get_currency()),
            $payment
        );
        $this->append_argument('currency', $order->get_currency(), $payment);

        if ($order instanceof Ep_Gateway_Refund) {
            ...
            // Refund FLASHPAY identifier in WooCommerce.
    ...
    {
        $this->append_argument('_plugin_version', Ep_Core::WC_EP_VERSION, $data);
    ...
    {
        // Identifier of merchant project received from FLASHPAY
        $this->append_argument('project_id', flashpay()->get_project_id(), $data);
    ...
    {
        // FLASHPAY internal interface type identifier
        $this->append_argument(
            'interface_type',
            $encode ? json_encode(flashpay()->get_interface_type()) : flashpay()->get_interface_type(),
            $data
        );
    ...
    {
        ep_get_log()->info(__('Append customer data to the form data.', 'woo-flashpay'));

        $values = apply_filters('ep_append_customer_country', $values, $order);
        $values = apply_filters('ep_append_customer_state', $values, $order);
        $values = apply_filters('ep_append_customer_city', $values, $order);
        $values = apply_filters('ep_append_customer_address', $values, $order);
        return apply_filters('ep_append_customer_zip', $values, $order);
    }
    ...
    /**
     * <h2>Appends FLASHPAY Payment Page Avs zip.</h2>
     *
     * @param Ep_Gateway_Order $order <p>Order object.</p>
     * @param array $values <p>Base array for appending data</p>
    ...
    /**
     * <h2>Appends FLASHPAY Payment Page Avs address.</h2>
     *
     * @param Ep_Gateway_Order $order <p>Order object.</p>
     * @param array $values <p>Base array for appending data</p>
     * @return array Result of appending data as new array.
     ...
     * @return array
     */
    public function append_card_operation_type($values)
    {
     ...
     * @return array <p>Result of appending data as new array.</p>
     */
    public function append_billing_data($values, $order)
    {
        $values = apply_filters('ep_append_billing_address', $values, $order);
        $values = apply_filters('ep_append_billing_city', $values, $order);
        $values = apply_filters('ep_append_billing_country', $values, $order);
        //ToDo: Disabled. Wrong value in some countries.
//        $values = apply_filters('ep_append_billing_region', $values, $order);
//        $values = apply_filters('ep_append_billing_region_code', $values, $order);

        return apply_filters('ep_append_billing_postal', $values, $order);
    }
    ...
    public function append_billing_region_code($values, $order)
    {
        $this->append_argument(
            'billing_region_code',
            ep_region_code($order->get_billing_country(), $order->get_billing_state()),
            $values
        );
     ...
     * @return array
     */
    public function append_merchant_callback_url(&$values)
    {
        $values['merchant_callback_url'] = ep_callback_url();
     ...
     * @return array
     */
    public function append_merchant_success_url($values, $value)
    {
    ...
    /**
     * <h2>Returns FLASHPAY Payment Page Mode settings.</h2>
     *
    ...
    /**
     * <h2>Returns FLASHPAY Payment Page Display mode settings.</h2>
     *
    ...
    {
        if ($value !== Ep_Gateway_Settings::MODE_REDIRECT) {
            $this->append_argument('frame_mode', $value, $values);

            if ($value === Ep_Gateway_Settings::MODE_IFRAME) {
                $this->append_argument('target_element', 'flashpay-iframe', $values);
            } elseif ($value === Ep_Gateway_Settings::MODE_EMBEDDED) {
                $this->append_argument('target_element', 'flashpay-iframe-embedded', $values);
            } elseif ($value === Ep_Gateway_Settings::MODE_POPUP && $missclick) {
    ...
    {
        switch (flashpay()->get_general_option(Ep_Gateway_Settings_General::OPTION_LANGUAGE, 'by_customer_browser')) {
            case Ep_Gateway_Settings_General::LANG_BY_CUSTOMER:
                return $values;
            case Ep_Gateway_Settings_General::LANG_BY_WORDPRESS:
                ...
                break;
            default:
                $lang = flashpay()->get_general_option(
                    Ep_Gateway_Settings_General::OPTION_LANGUAGE,
                    Ep_Gateway_Settings_General::LANG_ENGLISH
                );
        }
    ...
    /**
     * <h2>Returns FLASHPAY Payment Page custom variables.</h2>
     *
    ...
    {
        $values = apply_filters('ep_append_customer_id', $values, $order);

        $values = apply_filters('ep_append_customer_phone', $values, $order);
        $values = apply_filters('ep_append_customer_email', $values, $order);
        $values = apply_filters('ep_append_customer_first_name', $values, $order);
        $values = apply_filters('ep_append_customer_last_name', $values, $order);
        $values = apply_filters('ep_append_customer_data', $values, $order);
        $values = apply_filters('ep_append_billing_data', $values, $order);
        //ToDo: Temporary disabled
        // $values = apply_filters('ep_append_shipping_data', $values, $order);
        $values = apply_filters('ep_append_receipt_data', $values, $order, true);
        $values = apply_filters('ep_append_avs_post_code', $values, $order);
        $values = apply_filters('ep_append_avs_street_address', $values, $order);
        //ToDo: Temporary disabled
        // $values = apply_filters('ep_append_cash_voucher_data', $values, $order);

        return $values;
    }

    /**
     * <h2>Returns FLASHPAY Payment Page Subscription information.</h2>
     *
     * @param Ep_Gateway_Order $order <p>Order for payment.</p>
     * @since 2.0.0
    ...
    public function append_recurring($values, $order)
    {
        ...
        switch (true) {
            case ep_subscription_is_resubscribe($order):
                $subscriptions = ep_get_subscriptions_for_resubscribe_order($order);
                break;
            case $order->contains_subscription():
                $subscriptions = ep_get_subscriptions_for_order($order);
                break;
            default:
                return $values;
        }
        ...
        $recurring = [
            'register' => true,
            'type' => Ep_Gateway_Recurring_Types::AUTO,
            'amount' => ep_price_multiply($amount, $order->get_currency()),
        ];
    ...
    {
        return ep_get_signer()->sign($data);
    }
     ...
     *
     * @param array $data <p>FLASHPAY Payment Page form data.</p>
     * @since 2.0.0
    ...
    /**
     * <h2>Appends FLASHPAY Payment Page Receipt data.</h2>
     *
     * @param Ep_Gateway_Order $order <p>Order object.</p>
     * @param array $values <p>Base array for appending data</p>
    ...
    public function filter_receipt_data($values, $order, $encode = false)
    {
        ...
        apply_filters('ep_payment_page_clean_parameters', $data);
    ...
    public function receipt_data($order)
    {
        ...
        return $totalTax > 0
            ? [
                ...
                'total_tax_amount' => ep_price_multiply($totalTax, $order->get_currency()),
    ...
    public function filter_shipping_data($order, $values)
    {
        ...
        $shipping_args = [
            ...
            'region_code' => ep_region_code($order->get_shipping_country(), $order->get_shipping_state()),
            'name_indicator' => $order->get_shipping_name_indicator(),
        ];

        apply_filters('ep_payment_page_clean_parameters', $shipping_args);
...
//        }
        ...
        $data = [
            ...
            'amount' => ep_price_multiply($quantity > 0 ? $price / $quantity : $price, $currency),
        ];
        ...
        if ($totalTax > 0) {
            ...
            $data['tax_amount'] = ep_price_multiply($totalTax / $quantity, $currency);
        }
    ...
    private function append_argument($key, $value, &$values)
    {
        if ($value === null) {
            return;
        }
