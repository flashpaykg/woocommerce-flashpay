...
/**
 * Ep_Gateway_Operation_Status class
 *
 * @class    Ep_Gateway_Operation_Status
 * @since    2.0.0
...
class Ep_Gateway_Operation_Status
{
    ...
    {
        return [
            self::PROCESSING => _x('Processing', 'Operation status', 'woo-flashpay'),
            self::AWAITING_APPROVAL => _x('Awaiting approval', 'Operation status', 'woo-flashpay'),
            self::AWAITING_3DS => _x('Awaiting 3ds result', 'Operation status', 'woo-flashpay'),
            self::AWAITING_REDIRECT => _x('Awaiting redirect result', 'Operation status', 'woo-flashpay'),
            self::AWAITING_CUSTOMER => _x('Awaiting customer', 'Operation status', 'woo-flashpay'),
            self::AWAITING_CUSTOMER_ACTION => _x('Awaiting customer action', 'Operation status', 'woo-flashpay'),
            self::AWAITING_CLARIFICATION => _x('Awaiting clarification', 'Operation status', 'woo-flashpay'),
            self::EXTERNAL_PROCESSING => _x('External processing', 'Operation status', 'woo-flashpay'),
            self::EXTERNAL_ERROR => _x('External error', 'Operation status', 'woo-flashpay'),
            self::DECLINE => _x('Decline', 'Operation status', 'woo-flashpay'),
            self::SUCCESS => _x('Success', 'Operation status', 'woo-flashpay'),
            self::INTERNAL_ERROR => _x('Internal error', 'Operation status', 'woo-flashpay'),
            self::AWAITING_MERCHANT_AUTH => _x('Awaiting merchant auth', 'Operation status', 'woo-flashpay'),
            self::INVOICE_SENT => _x('Invoice sent', 'Operation status', 'woo-flashpay'),
            self::INVOICE_CANCELLED => _x('Invoice cancelled', 'Operation status', 'woo-flashpay'),
            self::EXPIRED => _x('Expired', 'Operation status', 'woo-flashpay'),
            self::AWAITING_PAYMENT => _x('Awaiting payment', 'Operation status', 'woo-flashpay'),
            self::UNKNOWN => _x('Unknown', 'Operation status', 'woo-flashpay'),
        ];
    }
