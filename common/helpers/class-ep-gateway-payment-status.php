...
/**
 * Ep_Gateway_Payment_Status class
 *
 * @class    Ep_Gateway_Payment_Status
 * @since    2.0.0
...
class Ep_Gateway_Payment_Status
{
    ...
    {
        return [
            self::PROCESSING => _x('Processing', 'Payment status', 'woo-flashpay'),
            self::AWAITING_APPROVAL => _x('Awaiting approval', 'Payment status', 'woo-flashpay'),
            self::AWAITING_CLARIFY => _x('Awaiting clarify', 'Payment status', 'woo-flashpay'),
            self::AWAITING_3DS => _x('Awaiting 3ds result', 'Payment status', 'woo-flashpay'),
            self::AWAITING_MERCHANT_AUTH => _x('Awaiting merchant auth', 'Payment status', 'woo-flashpay'),
            self::AWAITING_REDIRECT => _x('Awaiting redirect result', 'Payment status', 'woo-flashpay'),
            self::AWAITING_CUSTOMER_ACTION => _x('Awaiting customer action', 'Payment status', 'woo-flashpay'),
            self::AWAITING_CLARIFICATION => _x('Awaiting clarification', 'Payment status', 'woo-flashpay'),
            self::AWAITING_CAPTURE => _x('Awaiting capture', 'Payment status', 'woo-flashpay'),
            self::EXTERNAL_PROCESSING => _x('External processing', 'Payment status', 'woo-flashpay'),
            self::SCHEDULED_RECURRING_PROCESSING => _x('Scheduled recurring processing', 'Payment status', 'woo-flashpay'),
            self::SUCCESS => _x('Success', 'Payment status', 'woo-flashpay'),
            self::DECLINE => _x('Decline', 'Payment status', 'woo-flashpay'),
            self::ERROR => _x('Error', 'Payment status', 'woo-flashpay'),
            self::CANCELLED => _x('Cancelled', 'Payment status', 'woo-flashpay'),
            self::REVERSED => _x('Reversed', 'Payment status', 'woo-flashpay'),
            self::PARTIALLY_REFUNDED => _x('Partially refunded', 'Payment status', 'woo-flashpay'),
            self::PARTIALLY_REVERSED => _x('Partially reversed', 'Payment status', 'woo-flashpay'),
            self::REFUNDED => _x('Refunded', 'Payment status', 'woo-flashpay'),
            self::AWAITING_CUSTOMER => _x('Awaiting customer', 'Payment status', 'woo-flashpay'),
            self::INTERNAL_ERROR => _x('Internal error', 'Payment status', 'woo-flashpay'),
            self::EXTERNAL_ERROR => _x('External error', 'Payment status', 'woo-flashpay'),
            self::INVOICE_SENT => _x('Invoice sent', 'Payment status', 'woo-flashpay'),
            self::INVOICE_CANCELLED => _x('Invoice cancelled', 'Payment status', 'woo-flashpay'),
            self::AWAITING_PAYMENT => _x('Awaiting payment', 'Payment status', 'woo-flashpay'),
            self::EXPIRED => _x('Expired', 'Payment status', 'woo-flashpay'),
            self::AWAITING_RETRY => _x('Awaiting retry', 'Payment status', 'woo-flashpay'),
            self::PARTIALLY_PAID => _x('Partially paid', 'Payment status', 'woo-flashpay'),
            self::PARTIALLY_PAID_OUT => _x('Partially paid out', 'Payment status', 'woo-flashpay'),
            self::AWAITING_CLEARING => _x('Awaiting clearing', 'Payment status', 'woo-flashpay'),
            self::AWAITING_PARTIALLY_CLEARING => _x('Awaiting partially clearing', 'Payment status', 'woo-flashpay'),
            self::CLEARING_PROCESSING => _x('Clearing processing', 'Payment status', 'woo-flashpay'),
            self::AWAITING_CONFIRMATION => _x('Awaiting confirmation', 'Payment status', 'woo-flashpay'),
            self::DECLINE_RENEWAL => _x('Decline renewal', 'Payment status', 'woo-flashpay'),
                // INTERNAL STATUS
            self::INITIAL => _x('Awaiting payment', 'Payment status', 'woo-flashpay'),
        ];
    }
