...
/**
 * Ep_Gateway_Settings_General class
 *
 * @class    Ep_Gateway_Settings_General
 * @version  2.0.0
 * @package  Ep_Gateway/Settings
 * @category Class
 * @internal
 */
class Ep_Gateway_Settings_General extends Ep_Gateway_Settings
{
    ...
    // FLASHPAY Custom variables data
    const CUSTOM_RECEIPT_DATA = 'receipt_data';

    // FLASHPAY available language modes
    ...
    {
        $this->id = self::ID;
        $this->label = _x('General', 'Settings page', 'woo-flashpay');
        $this->icon = 'flashpay.svg';

        parent::__construct();

        add_filter('ep_' . $this->id . '_settings', [$this, 'add_uninstall_setting']);
        add_filter('ep_get_settings_' . $this->id, [$this, 'get_settings_general']);
    }
    ...
    public function get_settings_general()
    {
        $settings = [
            [
                ...
                self::FIELD_TITLE => _x('General Settings', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
            ],
            [
                self::FIELD_TITLE => _x('Merchant callback URL', 'Settings integration', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_TEXT,
                self::FIELD_DEFAULT => ep_callback_url(),
                self::FIELD_CUSTOM => [
                    'readonly' => 'readonly',
                ],
            ],
            [
                ...
                self::FIELD_TITLE => _x('Demo mode', 'Settings integration', 'woo-flashpay'),
            ...
            [
                ...
                self::FIELD_TITLE => _x('Project ID', 'Settings integration', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_NUMBER,
                self::FIELD_TIP => _x(
                    'Your project ID you could get from FLASHPAY helpdesk. Leave it blank if test mode',
                    'Settings integration',
                    'woo-flashpay'
                ),
            ],
            [
                ...
                self::FIELD_TITLE => _x('Secret key', 'Settings integration', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_PASSWORD,
                self::FIELD_TIP => _x(
                    'Secret key which is using to sign payment request. You could get it from FLASHPAY helpdesk',
                    'Settings integration',
                    'woo-flashpay'
                ),
            ],
            [
                ...
                self::FIELD_TITLE => _x('Language', 'Settings payment form', 'woo-flashpay'),
            ...
            [
                ...
                self::FIELD_TITLE => _x('Advanced options', 'Settings general form', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_TOGGLE_START
            ],

            [
                self::FIELD_ID => self::CACHING_OPTIONS,
                self::FIELD_TITLE => _x('Transaction Cache', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
                self::FIELD_DESC => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Enable Caching', 'Settings cache', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x(
                    'Enable',
                    'Settings cache',
                ...
                self::FIELD_SUFFIX => _x('Recommended.', 'Settings cache', 'woo-flashpay'),
                self::FIELD_DEFAULT => self::YES,
            ],
            [
                self::FIELD_ID => self::OPTION_CACHING_EXPIRATION,
                self::FIELD_TITLE => _x('Cache Expiration', 'Settings cache', 'woo-flashpay'),
                ...
                self::FIELD_DESC => _x('Default: 604800 (7 days).', 'Settings cache', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::CACHING_OPTIONS,
                self::FIELD_TYPE => self::TYPE_END,
            ...
            [
                ...
                self::FIELD_TITLE => _x('Shop Admin Setup', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
            ],
            [
                self::FIELD_ID => self::OPTION_LOG_LEVEL,
                self::FIELD_TITLE => _x('Log level', 'Settings shop admin setup', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_DROPDOWN,
                self::FIELD_TIP => _x(
                ...
                self::FIELD_OPTIONS => [
                    WC_Log_Levels::EMERGENCY => _x('Emergency', 'Log level', 'woo-flashpay'),
                    WC_Log_Levels::CRITICAL => _x('Critical', 'Log level', 'woo-flashpay'),
                    WC_Log_Levels::ALERT => _x('Alert', 'Log level', 'woo-flashpay'),
                    WC_Log_Levels::ERROR => _x('Error', 'Log level', 'woo-flashpay'),
                    WC_Log_Levels::WARNING => _x('Warning', 'Log level', 'woo-flashpay'),
                    WC_Log_Levels::NOTICE => _x('Notice', 'Log level', 'woo-flashpay'),
                    WC_Log_Levels::INFO => _x('Info', 'Log level', 'woo-flashpay'),
                    WC_Log_Levels::DEBUG => _x('Debug', 'Log level', 'woo-flashpay'),
                ],
                self::FIELD_DEFAULT => WC_Log_Levels::ERROR,
                self::FIELD_DESC => sprintf(
                    _x('Default: %s', 'Settings shop admin setup', 'woo-flashpay'),
                    _x('Error', 'Log level', 'woo-flashpay')
                ),
            ],
            [
                self::FIELD_ID => self::OPTION_TRANSACTION_INFO,
                self::FIELD_TITLE => _x('Fetch Payment Info', 'Settings shop admin setup', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x(
                    'Enable',
                    'Settings shop admin setup',
            ...
            [
                ...
                self::FIELD_TITLE => _x('Сomplete order automatically', 'Settings shop admin setup', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x(
                    'Enable',
                    'Settings shop admin setup',
    ...
    public function add_uninstall_setting($settings)
    {
        if (!is_multisite() || (is_main_site())) {
            $settings[] = [
                ...
                self::FIELD_TITLE => _x('Uninstalling', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
                self::FIELD_DESC => '',
            ];
            ...
            $settings[] = [
                ...
                self::FIELD_TITLE => _x('Delete orders', 'Settings uninstalling', 'woo-flashpay'),
                self::FIELD_DESC => _x(
                    'Delete orders with payment via FLASHPAY when uninstalling plugin.',
    ...
    {
        return [
            self::LANG_BY_CUSTOMER => _x('By Customer browser setting', 'Language', 'woo-flashpay'),
            self::LANG_BY_WORDPRESS => _x('By WordPress', 'Language', 'woo-flashpay'),
            self::LANG_ENGLISH => _x('English', 'Language', 'woo-flashpay'),
            self::LANG_FRANCE => _x('France', 'Language', 'woo-flashpay'),
            self::LANG_ITALIAN => _x('Italian', 'Language', 'woo-flashpay'),
            self::LANG_GERMANY => _x('Germany', 'Language', 'woo-flashpay'),
            self::LANG_SPANISH => _x('Spanish', 'Language', 'woo-flashpay'),
            self::LANG_RUSSIAN => _x('Russian', 'Language', 'woo-flashpay'),
        ];
    }
    ...
    {
        ep_get_view('html-admin-settings-log.php');
