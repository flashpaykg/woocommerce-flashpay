...
/**
 * Ep_Gateway_Settings_More class
 *
 * @class    Ep_Gateway_Settings_More
 * @version  3.0.0
 * @package  Ep_Gateway/Settings
 * @category Class
 * @internal
 */
class Ep_Gateway_Settings_More extends Ep_Gateway_Settings
{
    // region Constants
    ...
    {
        $this->id = self::ID;
        $this->label = _x('More methods', 'Settings page', 'woo-flashpay');

        parent::__construct();

        add_filter('ep_get_settings_' . $this->id, [$this, 'get_settings_more_methods']);
    }
    ...
    public function get_settings_more_methods()
    {
        $settings = [
            [
                ...
                self::FIELD_TITLE => _x('More payment methods settings', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
                self::FIELD_DESC => '',
            ],
            [
                self::FIELD_ID => self::OPTION_ENABLED,
                self::FIELD_TITLE => _x('Enable/Disable', 'Settings more payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x('Enable', 'Settings more payments', 'woo-flashpay'),
                self::FIELD_TIP => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Title', 'Settings more payments', 'woo-flashpay'),
                ...
                self::FIELD_DEFAULT => _x('More payment methods', 'Settings more payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::OPTION_SHOW_DESCRIPTION,
                self::FIELD_TITLE => _x('Show Description', 'Settings more payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Description', 'Settings more payments', 'woo-flashpay'),
            ...
            [
                ...
                self::FIELD_TITLE => _x('Order button text', 'Settings more payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_TEXT,
                self::FIELD_TIP => _x(
                ...
                self::FIELD_DEFAULT => _x('Go to payment', 'Settings more payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::OPTION_FORCE_CODE,
                self::FIELD_TITLE => _x('Payment method code', 'Settings more payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_TEXT,
                self::FIELD_DESC => sprintf(
                    ...
                    esc_url_raw('https://developers.flashpay.kg/en/en_pm_codes.html'),
                    _x(
