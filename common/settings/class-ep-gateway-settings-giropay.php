...
/**
 * Ep_Gateway_Settings_Giropay class
 *
 * @class    Ep_Gateway_Settings_Giropay
 * @version  3.0.0
 * @package  Ep_Gateway/Settings
 * @category Class
 * @internal
 */
class Ep_Gateway_Settings_Giropay extends Ep_Gateway_Settings
{
    // region Constants
    ...
    {
        $this->id = self::ID;
        $this->label = _x('Giropay', 'Settings page', 'woo-flashpay');
        $this->icon = 'giropay.svg';

        parent::__construct();

        add_filter('ep_get_settings_' . $this->id, [$this, 'get_settings_giropay_methods']);
    }
    ...
    public function get_settings_giropay_methods()
    {
        $settings = [
            [
                ...
                self::FIELD_TITLE => _x('Giropay settings', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
                self::FIELD_DESC => '',
            ],
            [
                self::FIELD_ID => self::OPTION_ENABLED,
                self::FIELD_TITLE => _x('Enable/Disable', 'Settings giropay payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x('Enable', 'Settings giropay payments', 'woo-flashpay'),
                self::FIELD_TIP => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Title', 'Settings giropay payments', 'woo-flashpay'),
                ...
                self::FIELD_DEFAULT => _x('Giropay', 'Settings giropay payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::OPTION_SHOW_DESCRIPTION,
                self::FIELD_TITLE => _x('Show Description', 'Settings giropay payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Description', 'Settings giropay payments', 'woo-flashpay'),
            ...
            [
                ...
                self::FIELD_TITLE => _x('Order button text', 'Settings giropay payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_TEXT,
                self::FIELD_TIP => _x(
                ...
                self::FIELD_DEFAULT => _x('Go to payment', 'Settings giropay payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::GIROPAY_SETTINGS,
