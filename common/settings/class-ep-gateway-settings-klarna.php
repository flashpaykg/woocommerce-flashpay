...
/**
 * Ep_Gateway_Settings_Klarna class
 *
 * @class    Ep_Gateway_Settings_Klarna
 * @version  3.0.0
 * @package  Ep_Gateway/Settings
 * @category Class
 * @internal
 */
class Ep_Gateway_Settings_Klarna extends Ep_Gateway_Settings
{
    // region Constants
    ...
    {
        $this->id = self::ID;
        $this->label = _x('Klarna', 'Settings page', 'woo-flashpay');
        $this->icon = 'klarna.svg';

        parent::__construct();

        add_filter('ep_get_settings_' . $this->id, [$this, 'get_settings_klarna_methods']);
    }
    ...
    public function get_settings_klarna_methods()
    {
        $settings = [
            [
                ...
                self::FIELD_TITLE => _x('Klarna settings', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
                self::FIELD_DESC => '',
            ],
            [
                self::FIELD_ID => self::OPTION_ENABLED,
                self::FIELD_TITLE => _x('Enable/Disable', 'Settings klarna payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x('Enable', 'Settings klarna payments', 'woo-flashpay'),
                self::FIELD_TIP => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Title', 'Settings klarna payments', 'woo-flashpay'),
                ...
                self::FIELD_DEFAULT => _x('Klarna', 'Settings klarna payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::OPTION_SHOW_DESCRIPTION,
                self::FIELD_TITLE => _x('Show Description', 'Settings klarna payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Description', 'Settings klarna payments', 'woo-flashpay'),
            ...
            [
                ...
                self::FIELD_TITLE => _x('Order button text', 'Settings klarna payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_TEXT,
                self::FIELD_TIP => _x(
                ...
                self::FIELD_DEFAULT => _x('Go to payment', 'Settings klarna payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::KLARNA_SETTINGS,
