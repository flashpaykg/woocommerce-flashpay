...
/**
* Ep_Gateway_Settings_PayPal_PayLater class
*
* @class    Ep_Gateway_Settings_PayPal_PayLater
* @version  3.4.3
* @package  Ep_Gateway/Settings
* @category Class
* @internal
*/
class Ep_Gateway_Settings_PayPal_PayLater extends Ep_Gateway_Settings
{
    /**
    * Internal identifier
    */
    const ID = 'flashpay-paypal-paylater';
    ...
    */
    ...
    {
        $this->id = self::ID;
        $this->label = _x('PayPal PayLater', 'Settings page', 'woo-flashpay');
        $this->icon = 'paypal-paylater.svg';

        parent::__construct();

        add_filter('ep_get_settings_' . $this->id, [$this, 'get_settings_paypal_paylater_methods']);
    }
    ...
    public function get_settings_paypal_paylater_methods(): array
    {
        $settings = [
            [
                ...
                self::FIELD_TITLE => _x('PayPal PayLater settings', 'Settings section', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_START,
                self::FIELD_DESC => '',
            ],
            [
                self::FIELD_ID => self::OPTION_ENABLED,
                self::FIELD_TITLE => _x('Enable/Disable', 'Settings paypal paylater payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x('Enable', 'Settings paypal paylater payments', 'woo-flashpay'),
                self::FIELD_TIP => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Title', 'Settings paypal paylater payments', 'woo-flashpay'),
                ...
                self::FIELD_DEFAULT => _x('PayPal Buy Now Pay Later', 'Settings paypal paylater payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::OPTION_SHOW_DESCRIPTION,
                self::FIELD_TITLE => _x('Show Description', 'Settings paypal paylater payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_CHECKBOX,
                self::FIELD_DESC => _x(
            ...
            [
                ...
                self::FIELD_TITLE => _x('Description', 'Settings paypal paylater payments', 'woo-flashpay'),
            ...
            [
                ...
                self::FIELD_TITLE => _x('Order button text', 'Settings paypal paylater payments', 'woo-flashpay'),
                self::FIELD_TYPE => self::TYPE_TEXT,
                self::FIELD_TIP => _x(
                ...
                self::FIELD_DEFAULT => _x('Go to payment', 'Settings paypal paylater payments', 'woo-flashpay'),
            ],
            [
                self::FIELD_ID => self::PAYPAL_PAYLATER_SETTINGS,
