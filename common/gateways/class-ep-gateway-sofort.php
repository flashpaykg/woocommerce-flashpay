...
/**
 * <h2>FLASHPAY Sofort Gateway.</h2>
 *
 * @class    Ep_Gateway_Sofort
 * @version  3.0.0
 * @package  Ep_Gateway/Gateways
 * @category Class
 */
class Ep_Gateway_Sofort extends Ep_Gateway
{
    ...
    /**
     * <h2>Instance of FLASHPAY Sofort Gateway.</h2>
     *
     * @var Ep_Gateway
     * @since 3.0.0
     */
    ...
    /**
     * <h2>FLASHPAY Sofort Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_Sofort::ID;
        $this->method_title = __('FLASHPAY SOFORT', 'woo-flashpay');
        $this->method_description = __('Accept payments via SOFORT.', 'woo-flashpay');
