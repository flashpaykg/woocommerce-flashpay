...
/**
 * <h2>FLASHPAY Banks Gateway.</h2>
 *
 * @class    Ep_Gateway_Banks
 * @version  2.0.0
 * @package  Ep_Gateway/Gateways
 * @category Class
 */
class Ep_Gateway_Banks extends Ep_Gateway
{
    ...
    /**
     * <h2>FLASHPAY Banks Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_Banks::ID;
        $this->method_title = __('FLASHPAY Open banking', 'woo-flashpay');
        $this->method_description = __('Accept payments via Open Banking.', 'woo-flashpay');
