...
/**
 * <h2>FLASHPAY Gateway Apple Pay.</h2>
 *
 * @class    Ep_Gateway_Applepay
 * @version  3.0.1
 * @package  Ep_Gateway/Gateways
 * @category Class
 */
class Ep_Gateway_Applepay extends Ep_Gateway
{
    ...
    /**
     * <h2>Instance of FLASHPAY Apple Pay Gateway.</h2>
     *
     * @var Ep_Gateway
     * @since 3.0.1
     */
    ...
    /**
     * <h2>FLASHPAY Apple Pay Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_Applepay::ID;
        $this->method_title = __('FLASHPAY ApplePay', 'woo-flashpay');
        $this->method_description = __('Accept payments via ApplePay.', 'woo-flashpay');
