...
/**
 * <h2>FLASHPAY Gateway Blik.</h2>
 *
 * @class    Ep_Gateway_Blik
 * @version  3.0.0
 * @package  Ep_Gateway/Gateways
 * @category Class
 */
class Ep_Gateway_Blik extends Ep_Gateway
{
    const PAYMENT_METHOD = 'blik';
    ...
    /**
     * <h2>Instance of FLASHPAY Blik Gateway.</h2>
     *
     * @var Ep_Gateway
     * @since 3.0.0
     */
    ...
    /**
     * <h2>FLASHPAY Blik Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_Blik::ID;
        $this->method_title = __('FLASHPAY Blik', 'woo-flashpay');
        $this->method_description = __('Accept payments via Blik.', 'woo-flashpay');
