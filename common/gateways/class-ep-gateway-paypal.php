...
/**
 * <h2>FLASHPAY Gateway PayPal.</h2>
 *
 * @class    Ep_Gateway_PayPal
 * @version  3.0.0
 * @package  Woocommerce_Flashpay/Classes
 * @category Class
 */
class Ep_Gateway_PayPal extends Ep_Gateway
{
    ...
    /**
     * <h2>FLASHPAY PayPal Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_PayPal::ID;
        $this->method_title = __('FLASHPAY PayPal', 'woo-flashpay');
        $this->method_description = __('Accept payments via PayPal.', 'woo-flashpay');
