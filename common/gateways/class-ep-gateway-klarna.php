...
/**
 * <h2>FLASHPAY Gateway Klarna.</h2>
 *
 * @class    Ep_Gateway_Klarna
 * @version  3.0.0
 * @package  Woocommerce_Flashpay/Classes
 * @category Class
 */
class Ep_Gateway_Klarna extends Ep_Gateway
{
    ...
    /**
     * <h2>Instance of FLASHPAY Klarna Gateway.</h2>
     *
     * @var Ep_Gateway
     * @since 3.0.0
     */
    ...
    /**
     * <h2>FLASHPAY Klarna Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_Klarna::ID;
        $this->method_title = __('FLASHPAY Klarna', 'woo-flashpay');
        $this->method_description = __('Accept payments via Klarna.', 'woo-flashpay');
