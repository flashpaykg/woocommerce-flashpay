...
/**
 * <h2>FLASHPAY Gateway Giropay.</h2>
 *
 * @class    Ep_Gateway_Giropay
 * @version  3.0.0
 * @package  Ep_Gateway/Gateways
 * @category Class
 */
class Ep_Gateway_Giropay extends Ep_Gateway
{
    ...
    /**
     * <h2>Instance of FLASHPAY Giropay Gateway.</h2>
     *
     * @var Ep_Gateway
     * @since 3.0.0
     */
    ...
    /**
     * <h2>FLASHPAY Giropay Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_Giropay::ID;
        $this->method_title = __('FLASHPAY Giropay', 'woo-flashpay');
        $this->method_description = __('Accept payments via Giropay.', 'woo-flashpay');
