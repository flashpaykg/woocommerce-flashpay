...
/**
 * <h2>FLASHPAY Gateway Brazil Online Banks.</h2>
 *
 * @class    Ep_Gateway_Brazil_Online_Banks
 * @version  3.3.0
 * @package  Ep_Gateway/Gateways
 * @category Class
 */
class Ep_Gateway_Brazil_Online_Banks extends Ep_Gateway
{
    const PAYMENT_METHOD = 'online-brazil-banks';
    ...
    /**
     * <h2>Instance of FLASHPAY Brazil Online Banks Gateway.</h2>
     *
     * @var Ep_Gateway
     * @since 3.3.0
     */
    ...
    /**
     * <h2>FLASHPAY Brazil Online Banks Gateway constructor.</h2>
     */
    public function __construct()
    {
        $this->id = Ep_Gateway_Settings_Brazil_Online_Banks::ID;
        $this->method_title = __('FLASHPAY Brazil', 'woo-flashpay');
        $this->method_description = __('Accept payments via Brazil.', 'woo-flashpay');
