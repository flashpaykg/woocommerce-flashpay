...
/**
 * Ep_Gateway_Info_Operation_Fee
 *
 * Contains the information about per-operation fee charged by flashpay.
 *
 * @class    Ep_Gateway_Info_Operation_Fee
 * @version  2.0.0
 * @package  Ep_Gateway/Info
 * @category Class
 */
class Ep_Gateway_Info_Operation_Fee extends Ep_Gateway_Json
{
    // region Constants
