...
/**
 * Ep_Gateway_Info_Operation
 *
 * Contains information about the operation
 *
 * @class    Ep_Gateway_Info_Operation
 * @version  2.0.0
 * @package  Ep_Gateway/Info
 * @category Class
 */
class Ep_Gateway_Info_Operation extends Ep_Gateway_Json
{
    // region Constants
    ...
    {
        $this->register(self::FIELD_SUM_INITIAL, Ep_Gateway_Info_Sum::class);
        $this->register(self::FIELD_SUM_CONVERTED, Ep_Gateway_Info_Sum::class);
        $this->register(self::FIELD_PROVIDER, Ep_Gateway_Info_Provider::class);
    ...
    {
        $this->try_get_json($sum, self::FIELD_SUM_INITIAL, new Ep_Gateway_Info_Sum());
        return $sum;
    }
    ...
    {
        $this->try_get_json($sum, self::FIELD_SUM_CONVERTED, new Ep_Gateway_Info_Sum());
        return $sum;
    }
     ...
     *
     * @return Ep_Gateway_Info_Provider
     */
    public function get_provider()
    {
        $this->try_get_json($provider, self::FIELD_PROVIDER, new Ep_Gateway_Info_Provider());
        return $provider;
    }
