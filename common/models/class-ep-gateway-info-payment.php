...
/**
 * Ep_Gateway_Info_Payment
 *
 * Contains the payment data
 *
 * @class    Ep_Gateway_Info_Payment
 * @version  2.0.0
 * @package  Ep_Gateway/Info
 * @category Class
 */
class Ep_Gateway_Info_Payment extends Ep_Gateway_Json
{
    /**
     * Label for unique FLASHPAY ID of the payment.
     */
    const FIELD_ID = 'id';
    ...
    /**
     * Label for the information about per-operation fee charged by flashpay.
     */
    const FIELD_OPERATION_FEE = 'operation_fee';

    /**
     * Label for unique FLASHPAY identifier of a refund.
     */
    ...
    {
        $this->register(self::FIELD_SUM, Ep_Gateway_Info_Sum::class);
        $this->register(self::FIELD_OPERATION_FEE, Ep_Gateway_Info_Operation_Fee::class);

        parent::__construct($data);
    }

    /**
     * <h2>Returns unique FLASHPAY ID of the payment.</h2>
     *
     * @return string
     */
     ...
     *
     * @param Ep_Gateway_Info_Sum &$sum <p>Container fo Sum information object.</p>
    ...
    /**
     * <h2>Returns unique FLASHPAY identifier of a refund.</h2>
     *
     * @return ?string
     */
    ...
    /**
     * <h2>Returns the information about per-operation fee charged by flashpay.</h2>
     *
     * @return ?Ep_Gateway_Info_Operation_Fee
     */
