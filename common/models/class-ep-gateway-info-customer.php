 ...
 *
 * @class    Ep_Gateway_Info_Customer
 * @version  2.0.0
 * @package  Ep_Gateway/Info
 * @category Class
 * @internal
 */
class Ep_Gateway_Info_Customer extends Ep_Gateway_Json
{
    // region Constants
    ...
    {
        $this->register(self::FIELD_BILLING, Ep_Gateway_Info_Billing::class);
     ...
     *
     * @return ?Ep_Gateway_Info_Billing Billing information, if available, or <b>NULL</b> otherwise.
     */
