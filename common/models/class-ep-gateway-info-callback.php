...
/**
 * Ep_Gateway_Info_Callback
 *
 * @class    Ep_Gateway_Info_Callback
 * @version  2.0.0
 * @package  Ep_Gateway/Info
 * @category Class
 */
class Ep_Gateway_Info_Callback extends Ep_Gateway_Json
{
    // region Constants
    ...
    /**
     * Label for identifier of merchant project received from FLASHPAY.
     */
    ...
    {
        $this->register(self::FIELD_ACCOUNT, Ep_Gateway_Info_Account::class);
        $this->register(self::FIELD_ACS, Ep_Gateway_Info_ACS::class);
        $this->register(self::FIELD_CUSTOMER, Ep_Gateway_Info_Customer::class);
        $this->register(self::FIELD_PAYMENT, Ep_Gateway_Info_Payment::class);
        $this->register(self::FIELD_RECURRING, Ep_Gateway_Info_Recurring::class);
        $this->register(self::FIELD_OPERATION, Ep_Gateway_Info_Operation::class);
    ...
    /**
     * <h2>Returns the project identifier in the payment platform FLASHPAY.</h2>
     *
     * @return int
     */
     ...
     *
     * @return ?Ep_Gateway_Info_Recurring
     */
     ...
     *
     * @param ?Ep_Gateway_Info_Recurring <p>Container for Recurring information object - variable by reference.</p>
    ...
    public function get_payment_sum(): ?Ep_Gateway_Json
    {
    ...
    public function get_payment_amount(): ?float
    {
        ...
        return ep_price_multiplied_to_float($payment_amount_minor, $currency);
    }
        ...
        return [
            ...
            self::FIELD_ERRORS => function ($value) {
                foreach ($value as &$item) {
                    $item = new Ep_Gateway_Info_Error($item);
                }
                return $value;
            }
        ];
