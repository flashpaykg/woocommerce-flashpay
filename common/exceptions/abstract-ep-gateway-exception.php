...
/**
 * Ep_Gateway_Exception abstract class
 *
 * @class   Ep_Gateway_Exception
 * @since   2.0.0
 * @package Ep_Gateway/Exceptions
 * @abstract
 * @internal
 */
abstract class Ep_Gateway_Exception extends Exception
{
    /**
     ...
     * @param int $code [optional] <p>Error code. Default: {@see Ep_Gateway_Error::UNKNOWN_ERROR}.</p>
     * @param ?Exception $previous [optional] <p>Previous exception. Default: null.</p>
     * @since 2.0.0
     */
    public function __construct($message, $code = Ep_Gateway_Error::UNKNOWN_ERROR, Exception $previous = null)
    {
